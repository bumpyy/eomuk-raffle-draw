...
<x-layouts::app>
    <div
        ...
        <div
            ...
            <article
                class="max-w-150 flex h-full w-full flex-col items-center justify-center rounded-2xl bg-white p-2.5 text-center shadow-[0_30px_30px_-25px_rgba(65,51,183,0.25)]">
                <a class="inline-flex items-center justify-between gap-2 rounded-md bg-white"
                    ...
                    <img src="{{ asset('img/plane-prize-2.png') }}" alt="">
                </a>
            </article>
