...
<x-layouts::app>
    <div
        ...
        <div
            ...
            <article
                class="max-w-150 flex h-full w-full justify-center rounded-2xl bg-white p-2.5 text-center shadow-[0_30px_30px_-25px_rgba(65,51,183,0.25)]">
            ...
            <article
                class="max-w-150 w-full rounded-2xl bg-white p-2.5 text-center shadow-[0_30px_30px_-25px_rgba(65,51,183,0.25)]">
